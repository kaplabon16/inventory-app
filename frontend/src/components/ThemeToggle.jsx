...
export default function ThemeToggle({ className = "" }) {
  ...
  return (
    <button
      ...
      className={`${baseClass} w-10 px-0 ${className}`.trim()}
    >
      {dark ? (
